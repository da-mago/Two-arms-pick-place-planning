; PDDL PARA MODO 2
; 1 alturas y movimientos diagonales (sin down y up)
...
;;;  Movimientos ARM1 : back - ARM2 : up_piece  ;;;

(:action move+back+up_piece
...
;;;  Movimientos ARM1 : front - ARM2 : up_piece  ;;;

(:action move+front+up_piece
    :parameters (?omf1 ?omf2 - agent ?x1 ?y1 ?z1 ?x2 ?y2 ?z2 ?x1n ?z2n - agent_pos )
    :precondition (and
                       (not (= ?omf1 ?omf2))
                       ;arm1
...
;;;  Movimientos ARM1 : right - ARM2 : up_piece  ;;;

(:action move+right+up_piece
...
;;;  Movimientos ARM1 : left - ARM2 : up_piece  ;;;

(:action move+left+up_piece
    :parameters (?omf1 ?omf2 - agent ?x1 ?y1 ?z1 ?x2 ?y2 ?z2 ?y1n ?z2n - agent_pos )
    :precondition (and
                       (not (= ?omf1 ?omf2))
                       ;arm1
...
;;;  Movimientos ARM1 : pick - ARM2 : up_piece  ;;;

(:action move+pick+up_piece
...
;;;  Movimientos ARM1 : drop - ARM2 : up_piece  ;;;

(:action move+drop+up_piece
    :parameters (?omf1 ?omf2 - agent ?x1 ?y1 ?z1 ?x2 ?y2 ?z2 ?z2n - agent_pos ?ps1 ?ps1n - piece_status ?piece1 - piece )
    :precondition (and
                       (not (= ?omf1 ?omf2))
                       (not (= ?piece1 ?piece2))
...
;;;  Movimientos ARM1 : stay - ARM2 : up_piece  ;;;

(:action move+stay+up_piece
...
;;;  Movimientos ARM1 : left-back - ARM2 : up_piece  ;;;

(:action move+left-back+up_piece
...
;;;  Movimientos ARM1 : left-front - ARM2 : up_piece  ;;;

(:action move+left-front+up_piece
    :parameters (?omf1 ?omf2 - agent ?x1 ?y1 ?z1 ?x2 ?y2 ?z2 ?x1n ?y1n ?z2n - agent_pos )
    :precondition (and
                       (not (= ?omf1 ?omf2))
                       ;arm1
...
;;;  Movimientos ARM1 : right-back - ARM2 : up_piece  ;;;

(:action move+right-back+up_piece
    :parameters (?omf1 ?omf2 - agent ?x1 ?y1 ?z1 ?x2 ?y2 ?z2 ?x1n ?y1n ?z2n - agent_pos )
    :precondition (and
                       (not (= ?omf1 ?omf2))
                       ;arm1
...
;;;  Movimientos ARM1 : right-front - ARM2 : up_piece  ;;;

(:action move+right-front+up_piece
    :parameters (?omf1 ?omf2 - agent ?x1 ?y1 ?z1 ?x2 ?y2 ?z2 ?x1n ?y1n ?z2n - agent_pos )
    :precondition (and
                       (not (= ?omf1 ?omf2))
                       ;arm1
...
;;;  Movimientos ARM1 : up_piece - ARM2 : back  ;;;

(:action move+up_piece+back
...
;;;  Movimientos ARM1 : up_piece - ARM2 : front  ;;;

(:action move+up_piece+front
    :parameters (?omf1 ?omf2 - agent ?x1 ?y1 ?z1 ?x2 ?y2 ?z2 ?z1n ?x2n - agent_pos )
    :precondition (and
                       (not (= ?omf1 ?omf2))
                       ;arm1
...
;;;  Movimientos ARM1 : up_piece - ARM2 : right  ;;;

(:action move+up_piece+right
...
;;;  Movimientos ARM1 : up_piece - ARM2 : left  ;;;

(:action move+up_piece+left
    :parameters (?omf1 ?omf2 - agent ?x1 ?y1 ?z1 ?x2 ?y2 ?z2 ?z1n ?y2n - agent_pos )
    :precondition (and
                       (not (= ?omf1 ?omf2))
                       ;arm1
...
;;;  Movimientos ARM1 : up_piece - ARM2 : pick  ;;;

(:action move+up_piece+pick
...
;;;  Movimientos ARM1 : up_piece - ARM2 : drop  ;;;

(:action move+up_piece+drop
    :parameters (?omf1 ?omf2 - agent ?x1 ?y1 ?z1 ?x2 ?y2 ?z2 ?z1n - agent_pos ?ps ?psn - piece_status ?piece - piece )
    :precondition (and
                       (not (= ?omf1 ?omf2))
                       ;arm1
...
;;;  Movimientos ARM1 : up_piece - ARM2 : stay  ;;;

(:action move+up_piece+stay
...
;;;  Movimientos ARM1 : up_piece - ARM2 : left-back  ;;;

(:action move+up_piece+left-back
...
;;;  Movimientos ARM1 : up_piece - ARM2 : left-front  ;;;

(:action move+up_piece+left-front
    :parameters (?omf1 ?omf2 - agent ?x1 ?y1 ?z1 ?x2 ?y2 ?z2 ?z1n ?x2n ?y2n - agent_pos )
    :precondition (and
                       (not (= ?omf1 ?omf2))
                       ;arm1
...
;;;  Movimientos ARM1 : up_piece - ARM2 : right-back  ;;;

(:action move+up_piece+right-back
    :parameters (?omf1 ?omf2 - agent ?x1 ?y1 ?z1 ?x2 ?y2 ?z2 ?z1n ?x2n ?y2n - agent_pos )
    :precondition (and
                       (not (= ?omf1 ?omf2))
                       ;arm1
...
;;;  Movimientos ARM1 : up_piece - ARM2 : right-front  ;;;

(:action move+up_piece+right-front
    :parameters (?omf1 ?omf2 - agent ?x1 ?y1 ?z1 ?x2 ?y2 ?z2 ?z1n ?x2n ?y2n - agent_pos )
    :precondition (and
                       (not (= ?omf1 ?omf2))
                       ;arm1
...
;;;  Movimientos ARM1 : up_piece - ARM2 : up_piece  ;;;

(:action move+up_piece+up_piece
...
;;;  Movimientos ARM1 : up_piece - ARM2 : down_piece  ;;;

(:action move+up_piece+down_piece
    :parameters (?omf1 ?omf2 - agent ?x1 ?y1 ?z1 ?x2 ?y2 ?z2 ?z1n ?z2n - agent_pos )
    :precondition (and
                       (not (= ?omf1 ?omf2))
                       (not (= ?piece1 ?piece2))
...
;;;  Movimientos ARM1 : down_piece - ARM2 : up_piece  ;;;

(:action move+down_piece+up_piece
    :parameters (?omf1 ?omf2 - agent ?x1 ?y1 ?z1 ?x2 ?y2 ?z2 ?z1n ?z2n - agent_pos )
    :precondition (and
                       (not (= ?omf1 ?omf2))
                       (not (= ?piece1 ?piece2))
